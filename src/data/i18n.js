...
export const ui = {
  ...
  en: {
    ...
    metaDescription: "Explore NON-conventional builds for all 60 League of Legends Classic (Season 3) champions: AP Master Yi, AP Gangplank, off-role picks and more. Random roulette of champion, lane and build.",
    releaseNote: "League of Legends Classic launches July 29, 2026 (Patch 26.15) — a Season 3 mode with 60 champions.",
