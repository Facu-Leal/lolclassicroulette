...
export const ui = {
  es: {
    ...
    metaDescription: "Builds NO convencionales para los 60 campeones de LoL Classic: AP Master Yi, Gangplank AP, Blitzcrank one-punch y más. Ruleta de campeón, línea y build.",
    releaseNote: "League of Legends Classic sale el 29 de julio de 2026 (Patch 26.15) — el modo clásico con 60 campeones.",
    nav: { home: "Inicio", roulette: "Ruleta", builds: "Builds" },
    hero: {
      kicker: "LoL Classic · 29 jul 2026",
  ...
  en: {
    ...
    metaDescription: "Off-meta builds for all 60 LoL Classic champions: AP Master Yi, AP Gangplank, one-shots and more. Random roulette of champion, lane and build.",
    releaseNote: "League of Legends Classic launches July 29, 2026 (Patch 26.15) — the classic mode with 60 champions.",
    nav: { home: "Home", roulette: "Roulette", builds: "Builds" },
    hero: {
      kicker: "LoL Classic · Jul 29, 2026",
