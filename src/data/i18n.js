...
export const ui = {
  es: {
    ...
    metaDescription: "Explorá builds NO convencionales para los 62 campeones de League of Legends Classic: AP Master Yi, Gangplank AP, Blitzcrank one-punch y más. Ruleta aleatoria de campeón, línea y build.",
    releaseNote: "League of Legends Classic sale el 29 de julio de 2026 (Patch 26.15) — Con 62 campeones.",
    nav: { home: "Inicio", roulette: "Ruleta", builds: "Builds" },
    hero: {
      kicker: "Modo Classic · 29 jul 2026",
  ...
  en: {
    ...
    metaDescription: "Explore NON-conventional builds for all 62 League of Legends Classic champions: AP Master Yi, AP Gangplank, off-role picks and more. Random roulette of champion, lane and build.",
    releaseNote: "League of Legends Classic launches July 29, 2026 (Patch 26.15) — a Classic mode with 62 champions.",
